...
/// 创建新的账户，不需要助记词。生成如下几个文件：1.私钥，2.公钥，3.钱包地址
...
//- (id<XBIP39AccountProtocol> _Nullable) retrieveAccountByMnemonicAndSavePrivKeyToPath:(NSString * _Nonnull)path language:(int)language mnemonic:(NSString * _Nonnull)mnemoni password:(NSString * _Nonnull)password error:(NSError * _Nonnull * _Nullable)error;
